			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.XvXiao.model.Order o=(com.XvXiao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.XvXiao.dao.UserDao userDao=new com.XvXiao.dao.UserDao();
						...
						<%
							...
							String paymentType=com.XvXiao.model.Payment.findByPaymentId(con,n);
							 %>
