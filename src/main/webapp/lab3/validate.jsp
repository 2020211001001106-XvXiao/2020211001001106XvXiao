...
<c:choose>
    ...
    <%--todo 7:use c:import to include login.jsp --%>
        <c:url value="login.jsp" var="error">
            <c:param name="message" value="${message}"></c:param>
        </c:url>
    <c:import url="${error}"></c:import>
    </c:otherwise>
</c:choose>
</body>
</html>
